...
<dhtmlx:body name="initializeDHTMLX" imagePath="imgs/">
    <dhtmlx:grid name="grid" id="gridbox">
        <dhtmlx:column name="column_1" header="first"/>
        <dhtmlx:column name="column_2" header="second"/>
        <dhtmlx:column name="column_3" header="third"/>        
        <dhtmlx:column name="column_4" header="fourth"/>
        <dhtmlx:column name="column_5" header="fifth"/>
        <dhtmlx:column name="column_6" header="sixth"/>        
    </dhtmlx:grid>
</dhtmlx:body>
...
<script language="JavaScript" type="text/javascript">
    function initialize() {
        ...
        initializeDHTMLX();
        alert( grid.getColIndexById("column_2") );    
    }
