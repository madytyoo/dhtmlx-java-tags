...
public class ToolbarButtonTwoState extends Component {
    ...
    public ToolbarButtonTwoState(Component parent,String id, String position, String text,String imageEnabled, String imageDisabled ,String title ) {
        this.parent = parent;
        this.id = id;
    ...
    public StringBuffer render(StringTemplateGroup templateGroup) {
        ...
        buffer.append( parent.getName() + ".addButtonTwoState('" + id + "'," + position + ",'" + text + "'" );
