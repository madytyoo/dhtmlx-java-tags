...
import com.mylaensys.dhtmlx.model.ToolbarButtonSelect;

import javax.servlet.jsp.JspException;

public class ToolbarButtonSelectTag extends BaseTag {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            if (isAuthorized()) {
                ...
                component = new ToolbarButtonSelect(parent.component, id, position, width, text,imageEnabled,imageDisabled,title);
            ...
            throw new JspException("Toolbar Button Select Tag may only reside within a Toolbar Tag");
        }
