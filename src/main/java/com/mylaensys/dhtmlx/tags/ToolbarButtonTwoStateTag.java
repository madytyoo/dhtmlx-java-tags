...
import com.mylaensys.dhtmlx.model.ToolbarButtonTwoState;

import javax.servlet.jsp.JspException;

public class ToolbarButtonTwoStateTag extends BaseTag {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            if (isAuthorized()) {
                ...
                component = new ToolbarButtonTwoState(parent.component, id, position, text,imageEnabled,imageDisabled,title);
