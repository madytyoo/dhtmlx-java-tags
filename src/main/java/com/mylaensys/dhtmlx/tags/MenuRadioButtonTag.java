...
import com.mylaensys.dhtmlx.model.MenuRadioButton;

import javax.servlet.jsp.JspException;
import javax.servlet.jsp.tagext.Tag;

public class MenuRadioButtonTag extends BaseTag {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            if (isAuthorized()) {
                ...
                MenuRadioButton radio = new MenuRadioButton(parent.component, nextTo, id, text, position, group, state, disabled);
                component = radio;
                parent.component.getComponents().add(component);
                accept(this.getParent());

                radio.setMenu((Menu) this.getMenu().component);
            } else {
                return SKIP_BODY;
            }
