...
import com.mylaensys.dhtmlx.model.FormCheckBox;

import javax.servlet.jsp.JspException;

public class FormCheckBoxTag extends BaseTag {
    ...
    public void accept( FormRadioButtonTag password ) { }
    public void accept( FormCheckBoxTag password ) { }
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            ...
            component = new FormCheckBox( parent.component, name ,label, value , checked );
